...
-   <div>
    ...
    tabla_reducida <- data.frame(
      Tópico = c("Accidentes", "Alto riesgo", "Asistencia en catástrofes", "Conflicto Mapuche",
    ...
    tabla_reducida |>
      ...
      tab_header(
        title = md("Tópicos y palabras más relevantes del modelo de tópicos")
      )
